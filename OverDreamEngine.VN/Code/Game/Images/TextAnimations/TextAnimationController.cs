...
namespace ODEngine.TextAnimations
{
    ...
    public class TextAnimationController : IUpdatable
    {
        ...
        public static TextAnimation CreateAnimation(string animName, GameImage gameImage, List<ScenarioStep.TextAnimationInfo.Var> vars, TextAnimation previous = null)
        {
            ...
            foreach (var item in vars)
            {
                ...
                ret.scenarioValues[propName] = item.value;
            }
