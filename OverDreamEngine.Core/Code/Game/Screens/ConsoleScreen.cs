...
namespace ODEngine.Game.Screens
{
    public class ConsoleScreen : Screen
    {
        ...
        public ConsoleScreen(ScreenManager screenManager, Renderer parent) : base(screenManager, parent)
        {
            ...
            consoleTextBox.Text = "";
            GUIElement.CreateImage(consoleRenderer, new Vector3(-19.2f / 4f, 0f, 0f), new Vector2(19.2f / 2f, 10.8f), new SColor(0f, 0f, 0f, 0.5f));
        ...
        private void InputProcess()
        {
            try
            {
                ...
                switch (parsedInput.nodes[0].item.ToLower()) //TODO: команды выделить в классы
                {
                    ...
                    case "position":
                        {
                            ...
                            {
                                case "x":
                                    entity.GetComponent<Renderer>().PositionX = float.Parse(parsedInput.nodes[3].item);
                                    break;
                                case "y":
                                    entity.GetComponent<Renderer>().PositionY = float.Parse(parsedInput.nodes[3].item);
                                    break;
                                case "z":
                                    entity.GetComponent<Renderer>().PositionZ = float.Parse(parsedInput.nodes[3].item);
                                    break;
                            }
                            break;
                        }
                    ...
                    case "test":
                        {
                            var imageTicket = ImageLoader.LoadRaw(new[] { "Images/" + "GUI/MainMenu/BackBackHeavy" + ".png" }, new Vector2Int(7680, 4320), SixLabors.ImageSharp.ColorMatrix.Identity);
        ...
        public void Print(string text)
        {
            ...
            FileManager.AppendAllText("Log.txt", text + "\n");
        }
