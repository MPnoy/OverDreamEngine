...
namespace ODEngine.Core
{
    public class RenderAtlas : IDisposable
    {
        public struct Texture
        {
            ...
            public void BlitFrom(RenderTexture texture, Material material = null)
            {
                ...
                if (texture != null)
                {
                    ...
                    material.SetVector4("BlitRect", new Vector4(0f, 0f, 1f, 1f));
                }

                UniformWriteThis(material);
                Graphics.Blit(null, renderAtlas.atlasTexture, material);
            }
        ...
        private static readonly Vector4 rectOne = new Vector4(0f, 0f, 1f, 1f);
        ...
        {
            defaultMaterial = new Material("Atlas/Identity", "Atlas/Identity", "Atlas/Identity");
        }
        ...
        public Texture BlitFrom(Texture texture, Vector2Int destSize, Material material = null)
        {
            ...
            Graphics.Blit(null, atlasTexture, material);
        ...
        private static void SetReadUniform(Material material, string uniformName, RenderTexture texture)
        {
            ...
            material.SetVector4(uniformName + "Rect", rectOne);
        }
